export declare const enum ErrorCode {
    OK = 0,
    INTERNAL_ERROR = 1,
    CLOUDDBZONE_INIT_FAILED = 4,
    CLOUDDBZONE_DOES_NOT_EXIST = 5,
    CLOUDDBZONE_NUM_EXCEEDS_LIMIT = 6,
    CLOUDDBZONE_IS_BUSY = 7,
    CLOUDDBZONE_IS_OPENED = 8,
    CLOUDDBZONE_IS_CLOSED = 9,
    SUBSCRIBER_IS_REGISTERED = 10,
    QUERY_POLICY_IS_ILLEGAL = 11,
    SNAPSHOT_NUM_EXCEEDS_LIMIT = 13,
    SDK_VERSION_COLLAPSE = 14,
    LOCAL_PERMISSION_DENIED = 15,
    OBJECT_TYPE_NO_EXIST = 16,
    OBJECT_TYPE_INFO_IS_INVALID = 17,
    CLOUDDBCONFIG_INVALID = 18,
    NO_DATA_FOUND = 19,
    TRANSFER_UNFINISHED = 20,
    OBJECTTYPE_VERSION_NOT_ALLOW_DOWNGRADE = 21,
    USER_KEY_INVALID = 50,
    DATA_ENCRYPTION_KEY_INVALID = 51,
    ENCRYPT_FAILED = 52,
    DECRYPT_FAILED = 53,
    ENCRYPTION_SALT_EMPTY = 54,
    NETWORK_UNAVAILABLE = 1000,
    SCHEMA_NEGOTIATING = 1001,
    SCHEMA_NEGOTIATE_FAIL = 1002,
    INPUT_PARAMETER_INVALID = 1003,
    COMMUNICATOR_QUEUE_FULL = 1004,
    COMMUNICATOR_UNINITIALIZED = 1005,
    COMMUNICATOR_DATA_LENGTH_INVALID = 1006,
    SYNC_TASK_NO_RESPONSE = 1007,
    SYNC_REQUEST_GENERATE_FAIL = 1008,
    SYNC_RESPONSE_PARSE_FAIL = 1009,
    SYNC_RESPONSE_CONTENT_ILLEGAL = 1010,
    GATE_COMM_OVER_TIME = 1011,
    CLIENT_TOKEN_REQUEST_FAIL = 1012,
    USER_INFO_REQUEST_ERROR = 1013,
    INVALID_APP_CONTEXT = 1014,
